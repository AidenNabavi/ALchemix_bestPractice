...
// مدیریت تنظیمات و پارامتر های پروتکل 
/**
کارش محدود کردن  یا تنظیمات پارامتر های استراتژی ها و سرمایه گذاری ها است 
این قرار داد سرپرست صدوقچه ها است که پارامتر هایی دارد که فقط ادمین میتواند آن ها را را بخواند 

 */
import {IVaultV2} from "../lib/IVaultV2.sol";
import {PermissionedProxy} from "../lib/utils/PermissionedProxy.sol";
import {IMYTStrategy} from "../lib/interfaces/IMYTStrategy.sol";
import {IAlchemistCurator} from "../lib/interfaces/IAlchemistCurator.sol";
